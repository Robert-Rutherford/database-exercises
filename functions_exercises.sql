...
SELECT * FROM employees.employees WHERE first_name IN ('Irena', 'Vidya', 'Maya') AND gender = 'M';
...
SELECT DATEDIFF(CURDATE(),hire_date) FROM employees.employees WHERE hire_date BETWEEN '1990-01-01' AND '1999-12-31'
